...
Note: While your \nameref{sec:framing_synthesis} can only be written \emph{after} you create your \nameref{sec:annotated_bibliography}, it should appear \emph{before} the list of sources in your submitted document. The synthesis will probably take about 750 words to do its job well.
